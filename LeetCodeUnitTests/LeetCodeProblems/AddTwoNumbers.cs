...
public class AddTwoNumbersTests
{
    ...
    {
        var l1 = new _002_AddTwoNumbers.ListNode(2,
            new _002_AddTwoNumbers.ListNode(4, new _002_AddTwoNumbers.ListNode(3)));
        var l2 = new _002_AddTwoNumbers.ListNode(5,
            new _002_AddTwoNumbers.ListNode(6, new _002_AddTwoNumbers.ListNode(4)));
    ...
    {
        var l1 = new _002_AddTwoNumbers.ListNode(9,
            new _002_AddTwoNumbers.ListNode(9, new _002_AddTwoNumbers.ListNode(9)));
